...
#align(center)[
  #text(size: 11pt)[*Devo ripassare fisica:* domani verifica o domani interrogazione]
  #v(0.1cm)
  ...
  [
    #align(center)[
      #cetz.canvas(length: 0.85cm, {
        ...
        circle((neuron-x - 0.6, 1.4), radius: 0.35, fill: viola.lighten(85%), stroke: 1pt + viola)
        content((neuron-x - 0.6, 1.4), text(size: 9pt)[$w_1$])

        circle((neuron-x + 0.6, 1.4), radius: 0.35, fill: viola.lighten(85%), stroke: 1pt + viola)
        content((neuron-x + 0.6, 1.4), text(size: 9pt)[$w_2$])

        line((neuron-x - 1.3, 0.4), (neuron-x + 1.3, 0.4), stroke: 0.5pt + gray)
        content((neuron-x, -0.4), text(size: 10pt)[$x_1 w_1 + x_2 w_2$])

        line((r + 0.1, 1.5), (neuron-x - 1.6 - 0.1, 0.5), stroke: 1.2pt + verde, mark: (end: "stealth", fill: verde, scale: 0.5))
        line((r + 0.1, -0.5), (neuron-x - 1.6 - 0.1, 0.5), stroke: 1.2pt + verde, mark: (end: "stealth", fill: verde, scale: 0.5))
    ...
    #align(center)[
      #box(stroke: 1pt + blu, radius: 5pt, fill: blu.lighten(92%), inset: 10pt)[
        *Regola di decisione:* #v(0.1cm)
        $y = cases(1 quad "se" quad x_1 w_1 + x_2 w_2 > 0, 0 quad "altrimenti")$
      ]
    ]
  ],
  [
