...
#align(center)[
  #text(size: 12pt)[*Controllo qualità sorpresa:* deve contenere macchinina o collanina ma non entrambi]
  #v(0.3cm)
  #text(size: 16pt, weight: "bold")[Sorpresa OK: $x_1$ ⊕ $x_2$]
  #v(0.2cm)
  #text(size: 10pt)[$x_1$ = macchinina, $x_2$ = collanina]
]
...
#align(center)[
  #box(stroke: 2pt + rosso, radius: 5pt, fill: rosso.lighten(92%), inset: 12pt)[
    #text(weight: "bold")[Pesi:] #h(0.5cm) $w_1 = ?$ , $quad w_2 = ?$ #h(1cm) #text(size: 10pt, fill: rosso)[Non esiste soluzione!]
  ]
]
